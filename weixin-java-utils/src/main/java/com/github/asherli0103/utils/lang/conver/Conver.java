...
package com.github.asherli0103.utils.lang.conver;


import com.github.asherli0103.utils.ArrayUtil;
...
public class Conver {
    ...
    public static Object parse(Class<?> clazz, Object value) {
        try {
            ...
            if (Date.class.isAssignableFrom(clazz)) {
                //判断标准日期
                return DateUtil.stringToDate(valueStr);
    ...
    public static Object parseBasic(Class<?> clazz, String valueStr) {
        ...
        switch (basicType) {
            ...
            case CHARACTER:
                return valueOf(valueStr.charAt(0));
            default:
                return null;
        }
    }
    ...
    public static Integer[] toIntArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && !isIgnoreConvertError) {
                throw new UtilException(MessageFormat.format("Convert [{0}] to Integer error!", values[i]));
            }
            ints[i] = v;
        }
        return ints;
    ...
    public static Long[] toLongArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && !isIgnoreConvertError) {
                throw new UtilException(MessageFormat.format("Convert [{0}] to Long error!", values[i]));
            }
            longs[i] = v;
        }
        return longs;
    ...
    public static Double[] toDoubleArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && !isIgnoreConvertError) {
                throw new UtilException(MessageFormat.format("Convert [{0}] to Double error!", values[i]));
            }
            doubles[i] = v;
        }
        return doubles;
    ...
    public static <T> Float[] toFloatArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && !isIgnoreConvertError) {
                throw new UtilException(MessageFormat.format("Convert [{0}] to Float error!", values[i]));
            }
            floats[i] = v;
        }
        return floats;
    ...
    public static Boolean[] toBooleanArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && !isIgnoreConvertError) {
                throw new UtilException(MessageFormat.format("Convert [{0}] to Boolean error!", values[i]));
            }
            bools[i] = v;
        }
        return bools;
