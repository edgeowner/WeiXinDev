...
public class DateLunarCalendar {
    ...
    private final static int[] lunarInfo = {0x4bd8, 0x4ae0, 0xa570, 0x54d5, 0xd260, 0xd950, 0x5554, 0x56af, 0x9ad0,
            ...
            0xb55f, 0x56a0, 0xa5b4, 0x25df, 0x92d0, 0xd2b2, 0xa950, 0xb557, 0x6ca0, 0xb550, 0x5355, 0x4daf, 0xa5b0,
            0x4573, 0x52bf, 0xa9a8, 0xe950, 0x6aa0, 0xaea6, 0xab50, 0x4b60, 0xaae4, 0xa570,
            0x5260, 0xf263, 0xd950, 0x5b57, 0x56a0, 0x96d0, 0x4dd5, 0x4ad0, 0xa4d0, 0xd4d4, 0xd250, 0xd558, 0xb540,
            ...
            0xb4a0, 0xbaa4, 0xad50, 0x55d9, 0x4ba0, 0xa5b0, 0x5176, 0x52bf, 0xa930, 0x7954, 0x6aa0, 0xad50, 0x5b52,
            0x4b60, 0xa6e6, 0xa4e0, 0xd260, 0xea65, 0xd530, 0x5aa0, 0x76a3, 0x96d0, 0x4afb,
            0x4ad0, 0xa4d0, 0xd0b6, 0xd25f, 0xd520, 0xdd45, 0xb5a0, 0x56d0, 0x55b2, 0x49b0, 0xa577, 0xa4b0, 0xaa50,
            0xb255, 0x6d2f, 0xada0, 0x4b63, 0x937f, 0x49f8, 0x4970, 0x64b0, 0x68a6, 0xea5f,
     ...
     */
    public DateLunarCalendar(long TimeInMillis) {
     ...
     * @param date 指定日期对象
     */
    public DateLunarCalendar(Date date) {
        if (date == null)
            date = new Date();
    ...
    private static int getLunarLeapDays(int lunarYear) {
        ...
        // 若该年没有闰月,返回0
        return getLunarLeapMonth(lunarYear) > 0 ? ((lunarInfo[lunarYear - 1899] &
                0xf) == 0xf ? 30 : 29) : 0;
    }
    ...
    private static int getLunarMonthDays(int lunarYear, int lunarMonth) {
        ...
        return ((lunarInfo[lunarYear - 1900] & (0x10000 >> lunarMonth)) != 0) ? 30
                : 29;
    }
    ...
    private void init(long timeInMillis) {
        if (timeInMillis > minTimeInMillis && timeInMillis < maxTimeInMillis) {
            ...
            this.maxDayInMonth = daysInLunarMonth != 0 ? daysInLunarMonth : getLunarMonthDays(this
