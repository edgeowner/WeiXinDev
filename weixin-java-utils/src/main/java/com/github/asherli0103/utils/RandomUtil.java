...
public class RandomUtil {
    ...
    public static <T> T randomEle(T[] t) {
        return randomEle(Arrays.asList(t));
    }
    ...
    public static void main(String[] args) {
        ...
        int random1 = getNotSimple(in, 1);
        System.out.println(random + "\t" + AMOUNT_OF_RED_PACKETS[random] + "\t\t|\t\t" + random1 + "\t" + AMOUNT_OF_RED_PACKETS[random1]);
    }
