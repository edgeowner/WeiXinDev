...
public class WxOpenCardServiceImplTest {
    ...
    public void testQueryCardCode() throws Exception {
        WxOpenCardResult wxOpenCardResult = this.wxService.getCardService().queryCardCode(this.cardId, this.code, false);
        assertNotNull(wxOpenCardResult);
        System.out.println(wxOpenCardResult);
    }
