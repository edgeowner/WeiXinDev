...
public class WxOpenMenuServiceImplTest {
    ...
    public void testMenuCreate(WxMenu wxMenu) throws WxErrorException {
        ...
        this.wxService.getMenuService().createMenu(wxMenu);
    }
    ...
    public void testGetSelfMenuInfo() throws Exception {
        WxOpenGetSelfMenuInfoResult selfMenuInfo = this.wxService.getMenuService().getSelfMenuInfo();
    ...
    public void testCreateMenu2() throws WxErrorException {
        ...
        this.wxService.getMenuService().createMenu(menu);
    }

    @Test(dependsOnMethods = {"testMenuCreate"})
    public void testMenuGet() throws WxErrorException {
        WxMenu wxMenu = this.wxService.getMenuService().getMenu();
    ...
    public void testMenuDelete() throws WxErrorException {
        this.wxService.getMenuService().deleteMenu();
    }
