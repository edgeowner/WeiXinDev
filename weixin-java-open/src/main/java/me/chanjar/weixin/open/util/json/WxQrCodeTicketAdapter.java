 ...
 * @author Daniel Qian
 */
public class WxQrCodeTicketAdapter implements JsonDeserializer<WxOpenQrCodeTicket> {

    @Override
    public WxOpenQrCodeTicket deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        WxOpenQrCodeTicket ticket = new WxOpenQrCodeTicket();
