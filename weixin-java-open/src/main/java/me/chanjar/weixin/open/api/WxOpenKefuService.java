 ...
 * @author Binary Wang
 */
public interface WxOpenKefuService {
     ...
     * </pre>
     */
    boolean sendKefuMessage(WxOpenKefuMessage message) throws WxErrorException;
     ...
     * </pre>
     */
    WxOpenKfList kfList() throws WxErrorException;
     ...
     * </pre>
     */
    WxOpenKfOnlineList kfOnlineList() throws WxErrorException;
     ...
     * </pre>
     */
    boolean kfAccountAdd(WxOpenKfAccountRequest request) throws WxErrorException;
     ...
     * </pre>
     */
    boolean kfAccountUpdate(WxOpenKfAccountRequest request) throws WxErrorException;
     ...
     * </pre>
     */
    boolean kfAccountInviteWorker(WxOpenKfAccountRequest request) throws WxErrorException;

    /**
     * <pre>
     * 上传客服头像
     * 详情请见：<a href="http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1458044813&token=&lang=zh_CN">客服管理</a>
     * 接口url格式：${@code http://api.weixin.qq.com/customservice/kfaccount/uploadheadimg?access_token=ACCESS_TOKEN&kf_account=KFACCOUNT}
     * </pre>
     */
     ...
     * 删除客服账号
     * 详情请见：<a href="http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1458044813&token=&lang=zh_CN">客服管理</a>
     * 接口url格式：${@code https://api.weixin.qq.com/customservice/kfaccount/del?access_token=ACCESS_TOKEN&kf_account=KFACCOUNT}
     * </pre>
     */
     ...
     * 接口url格式： ${@code https://api.weixin.qq.com/customservice/kfsession/create?access_token=ACCESS_TOKEN}
     * </pre>
     */
     ...
     * 开发者可以使用本接口，关闭一个会话。
     * 详情请见：<a href="http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1458044820&token=&lang=zh_CN">客服会话控制接口</a>
     * 接口url格式： ${@code https://api.weixin.qq.com/customservice/kfsession/close?access_token=ACCESS_TOKEN}
     * </pre>
     */
     ...
     * 详情请见：<a href="http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1458044820&token=&lang=zh_CN">客服会话控制接口</a>
     * 接口url格式： ${@code https://api.weixin.qq.com/customservice/kfsession/getsession?access_token=ACCESS_TOKEN&openid=OPENID}
     * </pre>
     */
    WxOpenKfSessionGetResult kfSessionGet(String openid) throws WxErrorException;
     ...
     * 接口url格式： ${@code https://api.weixin.qq.com/customservice/kfsession/getsessionlist?access_token=ACCESS_TOKEN&kf_account=KFACCOUNT}
     * </pre>
     */
    WxOpenKfSessionList kfSessionList(String kfAccount) throws WxErrorException;
     ...
     * 详情请见：<a href="http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1458044820&token=&lang=zh_CN">客服会话控制</a>
     * 接口url格式：${@code  https://api.weixin.qq.com/customservice/kfsession/getwaitcase?access_token=ACCESS_TOKEN}
     * </pre>
     */
    WxOpenKfSessionWaitCaseList kfSessionGetWaitCase() throws WxErrorException;
     ...
     * 接口url格式：  ${@code https://api.weixin.qq.com/customservice/msgrecord/getmsglist?access_token=ACCESS_TOKEN}
     * </pre>
     *
     ...
     * @throws WxErrorException
     */
    WxOpenKfMsgList kfMsgList(Date startTime, Date endTime, Long msgId, Integer number) throws WxErrorException;
     ...
     * @throws WxErrorException
     */
    WxOpenKfMsgList kfMsgList(Date startTime, Date endTime) throws WxErrorException;
