...
public class WxOpenMaterialFileBatchGetGsonItemAdapter implements JsonDeserializer<WxOpenMaterialFileBatchGetResult.WxMaterialFileBatchGetNewsItem> {

    @Override
    public WxOpenMaterialFileBatchGetResult.WxMaterialFileBatchGetNewsItem deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        WxOpenMaterialFileBatchGetResult.WxMaterialFileBatchGetNewsItem wxMaterialFileBatchGetNewsItem = new WxOpenMaterialFileBatchGetResult.WxMaterialFileBatchGetNewsItem();
