...
public class WxOpenMassNewsArticleGsonAdapter implements JsonSerializer<WxOpenMassNews.WxOpenMassNewsArticle>, JsonDeserializer<WxOpenMassNews.WxOpenMassNewsArticle> {

    @Override
    public JsonElement serialize(WxOpenMassNews.WxOpenMassNewsArticle article, Type typeOfSrc, JsonSerializationContext context) {
    ...
    @Override
    public WxOpenMassNews.WxOpenMassNewsArticle deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        JsonObject articleInfo = jsonElement.getAsJsonObject();
        WxOpenMassNews.WxOpenMassNewsArticle article = new WxOpenMassNews.WxOpenMassNewsArticle();
