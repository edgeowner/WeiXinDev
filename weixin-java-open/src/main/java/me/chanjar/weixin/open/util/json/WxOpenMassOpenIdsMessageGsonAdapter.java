...
public class WxOpenMassOpenIdsMessageGsonAdapter implements JsonSerializer<WxOpenMassOpenIdsMessage> {

    @Override
    public JsonElement serialize(WxOpenMassOpenIdsMessage message, Type typeOfSrc, JsonSerializationContext context) {
