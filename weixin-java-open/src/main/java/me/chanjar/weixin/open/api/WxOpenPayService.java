 ...
 */
public interface WxOpenPayService {
     ...
     * 详见${@code http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1421141115&token=&lang=zh_CN}
     *
     * @param request 请求对象，注意一些参数如appid、mchid等不用设置，方法内会自动从配置对象中获取到（前提是对应配置中已经设置）
     * @throws WxErrorException
     */
     ...
     * <pre>
     * 文档详见:
     * 发送普通红包${@code https://pay.weixin.qq.com/wiki/doc/api/tools/cash_coupon.php?chapter=13_4&index=3}
     *  接口地址：${@code https://api.mch.weixin.qq.com/mmpaymkttransfers/sendredpack}
     * 发送裂变红包 ${@code https://pay.weixin.qq.com/wiki/doc/api/tools/cash_coupon.php?chapter=13_5&index=4}
     *  接口地址：${@code https://api.mch.weixin.qq.com/mmpaymkttransfers/sendgroupredpack}
     * </pre>
     *
     * @param request 请求对象
     * @param keyFile 证书文件对象
     ...
     * 文档详见:${@code https://pay.weixin.qq.com/wiki/doc/api/tools/mch_pay.php?chapter=14_2}
     * 接口链接：${@code https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers}
     * </pre>
     *
     * @param request 请求对象
     * @param keyFile 证书文件对象
     ...
     * 文档详见: ${@code https://pay.weixin.qq.com/wiki/doc/api/tools/mch_pay.php?chapter=14_3}
