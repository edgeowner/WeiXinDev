...
public class WxOpenTemplate {
    ...
    public static List<WxOpenTemplate> fromJson(String json) {
        return WxOpenGsonBuilder.create().fromJson(JSON_PARSER.parse(json).getAsJsonObject().get("template_list"),
                new TypeToken<List<WxOpenTemplate>>() {
                }.getType());
    }
