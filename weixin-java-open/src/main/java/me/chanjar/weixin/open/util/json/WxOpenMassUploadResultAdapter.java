 ...
 * @author Daniel Qian
 */
public class WxOpenMassUploadResultAdapter implements JsonDeserializer<WxOpenMassUploadResult> {

    @Override
    public WxOpenMassUploadResult deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        WxOpenMassUploadResult uploadResult = new WxOpenMassUploadResult();
