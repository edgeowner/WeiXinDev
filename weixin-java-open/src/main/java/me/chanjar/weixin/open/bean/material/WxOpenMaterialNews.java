...
public class WxOpenMaterialNews implements Serializable {
    private static final long serialVersionUID = -3283203652013494976L;

    private List<WxOpenMaterialNewsArticle> articles = new ArrayList<>();

    public List<WxOpenMaterialNewsArticle> getArticles() {
        return this.articles;
    }

    public void addArticle(WxOpenMaterialNewsArticle article) {
     ...
     * @author chanjarster
     */
    public static class WxOpenMaterialNewsArticle {
        /**
