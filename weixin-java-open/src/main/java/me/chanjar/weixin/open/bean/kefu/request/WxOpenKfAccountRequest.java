...
public class WxOpenKfAccountRequest implements Serializable {
    ...
    public static class Builder {
        ...
        public Builder from(WxOpenKfAccountRequest origin) {
        ...
        public WxOpenKfAccountRequest build() {
            WxOpenKfAccountRequest m = new WxOpenKfAccountRequest();
