 ...
 * @author Daniel Qian
 */
public class WxOpenMassVideoAdapter implements JsonSerializer<WxOpenMassVideo> {

    @Override
    public JsonElement serialize(WxOpenMassVideo message, Type typeOfSrc, JsonSerializationContext context) {
