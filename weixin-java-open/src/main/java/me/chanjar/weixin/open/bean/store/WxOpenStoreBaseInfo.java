 ...
 */
public class WxOpenStoreBaseInfo {
    /**
     * sid
    ...
    private List<WxOpenStorePhoto> photos;
    /**
     * recommend
    ...
    public static WxOpenStoreBaseInfo fromJson(String json) {
        return WxOpenGsonBuilder.create().fromJson(json, WxOpenStoreBaseInfo.class);
    }

    public static WxOpenStoreBaseInfoBuilder builder() {
        return new WxOpenStoreBaseInfoBuilder();
    }
    ...
    public String toJson() {
        JsonElement base_info = WxOpenGsonBuilder.create().toJsonTree(this);
    ...
    public List<WxOpenStorePhoto> getPhotos() {
        return this.photos;
    }

    public void setPhotos(List<WxOpenStorePhoto> photos) {
        this.photos = photos;
    }
    ...
    public static class WxOpenStorePhoto {
        /**
         * 照片url
         */
    ...
    public static class WxOpenStoreBaseInfoBuilder {
        private String sid;
        private String businessName;
        private String branchName;
        private String province;
        ...
        public WxOpenStoreBaseInfoBuilder sid(String sid) {
            this.sid = sid;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder businessName(String businessName) {
            this.businessName = businessName;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder branchName(String branchName) {
            this.branchName = branchName;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder province(String province) {
            this.province = province;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder city(String city) {
            this.city = city;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder district(String district) {
            this.district = district;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder address(String address) {
            this.address = address;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder telephone(String telephone) {
            this.telephone = telephone;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder categories(String[] categories) {
            this.categories = categories;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder offsetType(Integer offsetType) {
            this.offsetType = offsetType;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder longitude(BigDecimal longitude) {
            this.longitude = longitude;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder latitude(BigDecimal latitude) {
            this.latitude = latitude;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder photos(List<WxOpenStorePhoto> photos) {
            this.photos = photos;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder recommend(String recommend) {
            this.recommend = recommend;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder special(String special) {
            this.special = special;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder introduction(String introduction) {
            this.introduction = introduction;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder openTime(String openTime) {
            this.openTime = openTime;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder avgPrice(Integer avgPrice) {
            this.avgPrice = avgPrice;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder availableState(Integer availableState) {
            this.availableState = availableState;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder updateStatus(Integer updateStatus) {
            this.updateStatus = updateStatus;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder poiId(String poiId) {
            this.poiId = poiId;
            return this;
        }

        public WxOpenStoreBaseInfoBuilder from(WxOpenStoreBaseInfo origin) {
            this.sid(origin.sid);
        ...
        public WxOpenStoreBaseInfo build() {
            WxOpenStoreBaseInfo m = new WxOpenStoreBaseInfo();
            m.sid = this.sid;
