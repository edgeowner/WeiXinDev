 ...
 */
public interface WxOpenStoreService {
    /**
     * <pre>
     * 创建门店
     * 接口说明
     ...
     * </pre>
     */
    void add(WxOpenStoreBaseInfo request) throws WxErrorException;
     ...
     */
    WxOpenStoreBaseInfo get(String poiId) throws WxErrorException;
     ...
     * @throws WxErrorException
     */
    WxOpenStoreListResult list(int begin, int limit) throws WxErrorException;
     ...
     * @throws WxErrorException
     */
    List<WxOpenStoreInfo> listAll() throws WxErrorException;
     ...
     * @throws WxErrorException
     */
    void update(WxOpenStoreBaseInfo info) throws WxErrorException;
