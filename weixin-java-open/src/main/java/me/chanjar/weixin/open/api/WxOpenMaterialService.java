 ...
 * </pre>
 */
public interface WxOpenMaterialService {
     ...
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/media/upload?access_token=ACCESS_TOKEN&type=TYPE}
     * </pre>
     *
     ...
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/media/get?access_token=ACCESS_TOKEN&media_id=MEDIA_ID}
     * </pre>
     *
     * @param media_id
     * @return 保存到本地的临时文件
     ...
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/media/uploadimg?access_token=ACCESS_TOKEN}
     * </pre>
     *
     * @param file 上传的文件对象
     ...
     * 详情请见: <a href="http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1444738729&token=&lang=zh_CN">新增永久素材</a>
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/material/add_material?access_token=ACCESS_TOKEN&type=TYPE}
     *
     ...
     *
     * @param mediaType 媒体类型, 请看{@link me.chanjar.weixin.common.api.WxConsts}
     * @param material  上传的素材, 请看{@link WxOpenMaterial}
     */
    WxOpenMaterialUploadResult materialFileUpload(String mediaType, WxOpenMaterial material) throws WxErrorException;
     ...
     *
     * 详情请见: <a href="http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1444738729&token=&lang=zh_CN">新增永久素材</a>
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/material/add_news?access_token=ACCESS_TOKEN}
     *
     * 除了3天就会失效的临时素材外，开发者有时需要永久保存一些素材，届时就可以通过本接口新增永久素材。
     * 永久图片素材新增后，将带有URL返回给开发者，开发者可以在腾讯系域名内使用（腾讯系域名外使用，图片将被屏蔽）。
     * 请注意：
     ...
     * </pre>
     *
     * @param news 上传的图文消息, 请看{@link WxOpenMaterialNews}
     */
    WxOpenMaterialUploadResult materialNewsUpload(WxOpenMaterialNews news) throws WxErrorException;
     ...
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/material/get_material?access_token=ACCESS_TOKEN}
     * </pre>
     *
     ...
     * @param mediaId 永久素材的id
     */
    WxOpenMaterialVideoInfoResult materialVideoInfo(String mediaId) throws WxErrorException;
     ...
     * @param mediaId 永久素材的id
     */
    WxOpenMaterialNews materialNewsInfo(String mediaId) throws WxErrorException;
     ...
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/material/update_news?access_token=ACCESS_TOKEN}
     * </pre>
     *
     * @param wxOpenMaterialArticleUpdate 用来更新图文素材的bean, 请看{@link WxOpenMaterialArticleUpdate}
     */
    boolean materialNewsUpdate(WxOpenMaterialArticleUpdate wxOpenMaterialArticleUpdate) throws WxErrorException;
     ...
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/material/del_material?access_token=ACCESS_TOKEN}
     * </pre>
     *
     * @param mediaId 永久素材的id
     */
     ...
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/material/get_materialcount?access_token=ACCESS_TOKEN}
     * </pre>
     */
    WxOpenMaterialCountResult materialCount() throws WxErrorException;
     ...
     * 接口url格式：${@code https://api.weixin.qq.com/cgi-bin/material/batchget_material?access_token=ACCESS_TOKEN}
     * </pre>
     *
     * @param offset 从全部素材的该偏移位置开始返回，0表示从第一个素材 返回
     * @param count  返回素材的数量，取值在1到20之间
     */
    WxOpenMaterialNewsBatchGetResult materialNewsBatchGet(int offset, int count) throws WxErrorException;
     ...
     * @param count  返回素材的数量，取值在1到20之间
     */
    WxOpenMaterialFileBatchGetResult materialFileBatchGet(String type, int offset, int count) throws WxErrorException;
