...
import me.chanjar.weixin.open.builder.kefu.*;
 ...
 * @author chanjarster
 */
public class WxOpenKefuMessage implements Serializable {
     ...
     */
    public static OpenNewsBuilder MPNEWS() {
        return new OpenNewsBuilder();
    }
    ...
    public String getOpenNewsMediaId() {
        return this.mpNewsMediaId;
    }

    public void setOpenNewsMediaId(String mpNewsMediaId) {
