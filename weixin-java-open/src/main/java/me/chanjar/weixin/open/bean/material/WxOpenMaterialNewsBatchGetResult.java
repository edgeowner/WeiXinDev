...
public class WxOpenMaterialNewsBatchGetResult implements Serializable {
    ...
    public static class WxMaterialNewsBatchGetNewsItem {
        ...
        private WxOpenMaterialNews content;
        ...
        public WxOpenMaterialNews getContent() {
            return this.content;
        }

        public void setContent(WxOpenMaterialNews content) {
