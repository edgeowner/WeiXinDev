...
public class WxOpenMaterialNewsArticleGsonAdapter implements JsonSerializer<WxOpenMaterialNews.WxOpenMaterialNewsArticle>, JsonDeserializer<WxOpenMaterialNews.WxOpenMaterialNewsArticle> {

    @Override
    public JsonElement serialize(WxOpenMaterialNews.WxOpenMaterialNewsArticle article, Type typeOfSrc, JsonSerializationContext context) {
    ...
    @Override
    public WxOpenMaterialNews.WxOpenMaterialNewsArticle deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
