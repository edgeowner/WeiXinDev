...
public class WxOpenMassTagMessageGsonAdapter implements JsonSerializer<WxOpenMassTagMessage> {

    @Override
    public JsonElement serialize(WxOpenMassTagMessage message, Type typeOfSrc, JsonSerializationContext context) {
