 ...
 * @author Daniel Qian
 */
public class WxOpenMassSendResultAdapter implements JsonDeserializer<WxOpenMassSendResult> {

    @Override
    public WxOpenMassSendResult deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        WxOpenMassSendResult sendResult = new WxOpenMassSendResult();
