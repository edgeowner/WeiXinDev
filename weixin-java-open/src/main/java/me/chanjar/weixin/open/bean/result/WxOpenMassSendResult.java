 ...
 * @author chanjarster
 */
public class WxOpenMassSendResult implements Serializable {
    ...
    public static WxOpenMassSendResult fromJson(String json) {
        return WxOpenGsonBuilder.create().fromJson(json, WxOpenMassSendResult.class);
    }
