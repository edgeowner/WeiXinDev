 ...
 * @author chanjarster
 */
public class WxOpenMassNews implements Serializable {

    /**
     *
     */
    private static final long serialVersionUID = 565937155013581016L;
    private List<WxOpenMassNewsArticle> articles = new ArrayList<>();

    public List<WxOpenMassNewsArticle> getArticles() {
        return this.articles;
    }

    public void addArticle(WxOpenMassNewsArticle article) {
     ...
     * @author chanjarster
     */
    public static class WxOpenMassNewsArticle {
        /**
