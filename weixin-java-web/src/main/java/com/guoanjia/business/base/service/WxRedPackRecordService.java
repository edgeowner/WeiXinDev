...
import com.guoanjia.business.base.entity.WxRedPackRecord;
 ...
 * @version 1.0.00
 */
public interface WxRedPackRecordService extends BaseService<WxRedPackRecord, String> {
    AjaxJson payment(PaymentParameters parameters);

    AjaxJson sendRedPack(String openid, String clientIp, String userphone, JedisPool jedisPool);
}
