...
public interface WxUserService extends BaseService<WxUser, String> {
    AjaxJson sendVCode(SendVCodeParameters params);

    AjaxJson checkVCode(CheckVCodeParameters params);

    AjaxJson queryUserInfo(WxUser params);

    Long getActivityUserCount(String actId);
}
