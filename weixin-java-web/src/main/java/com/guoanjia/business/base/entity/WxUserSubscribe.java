 ...
 */
@Entity
@Table(name = "wx_user_subscribe")
public class WxUserSubscribe extends IdEntity implements Serializable {
    ...
    public WxUserSubscribe setuOpenid(String uOpenid) {
    ...
    public WxUserSubscribe setuUserphone(String uUserphone) {
    ...
    public WxUserSubscribe setuNickname(String uNickname) {
    ...
    public WxUserSubscribe setuCity(String uCity) {
    ...
    public WxUserSubscribe setuProvince(String uProvince) {
    ...
    public WxUserSubscribe setuCountry(String uCountry) {
    ...
    public WxUserSubscribe setuHeadimg(String uHeadimg) {
    ...
    public WxUserSubscribe setuNameCustom(String uNameCustom) {
    ...
    public WxUserSubscribe setuHeadimgCustom(String uHeadimgCustom) {
    ...
    public WxUserSubscribe setuHeadimgLocal(String uHeadimgLocal) {
    ...
    public WxUserSubscribe setuCreateTime(Date uCreateTime) {
    ...
    public WxUserSubscribe setuSex(String uSex) {
    ...
    public WxUserSubscribe setuPrivilege(String uPrivilege) {
    ...
    public WxUserSubscribe setuUnionid(String uUnionid) {
