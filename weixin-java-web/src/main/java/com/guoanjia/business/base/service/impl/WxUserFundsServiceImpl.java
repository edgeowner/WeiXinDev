...
@Service
@Transactional
public class WxUserFundsServiceImpl extends BaseServiceImpl<WxUserFunds, String> implements WxUserFundsService {
    public WxUserFundsServiceImpl(BaseRepository<WxUserFunds, String> baseRepository) {
