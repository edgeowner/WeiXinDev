...
import com.guoanjia.business.base.entity.jpa.WxUserActivityRepository;
...
@Service
@Transactional
public class WxUserActivityServiceImpl extends BaseServiceImpl<WxUserActivity, String> implements WxUserActivityService {

    private final WxUserActivityRepository wxUserActivityRepository;

    public WxUserActivityServiceImpl(BaseRepository<WxUserActivity, String> baseRepository, WxUserActivityRepository wxUserActivityRepository) {
