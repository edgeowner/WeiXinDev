 ...
 * @version 1.0.00
 */
public interface WxAgentFundsService extends BaseService<WxAgentFunds, String> {
    double queryAgentFunds(String openid);

    AjaxJson queryAllAgentFunds(WxAgentFunds wxAgentFunds);
