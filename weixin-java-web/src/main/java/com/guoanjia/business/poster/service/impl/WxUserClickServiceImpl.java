...
@Service
@Transactional
public class WxUserClickServiceImpl extends BaseServiceImpl<WxUserClick, String> implements WxUserClickService {
    public WxUserClickServiceImpl(BaseRepository<WxUserClick, String> baseRepository) {
