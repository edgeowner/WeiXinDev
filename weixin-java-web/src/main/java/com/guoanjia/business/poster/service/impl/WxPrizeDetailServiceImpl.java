...
@Service
@Transactional
public class WxPrizeDetailServiceImpl extends BaseServiceImpl<WxPrizeDetail, String> implements WxPrizeDetailService {
    public WxPrizeDetailServiceImpl(BaseRepository<WxPrizeDetail, String> baseRepository) {
