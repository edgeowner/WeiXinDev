 ...
 * @version 1.0.00
 */
public interface WxCapitalPoolService extends BaseService<WxCapitalPool,String> {

     @Transactional(rollbackFor = {WxErrorException.class})
     AjaxJson randomRedPack(String openid, String userphone) throws WxErrorException;
