 ...
 * @version 1.0.00
 */
public interface WxBlessingInfoService extends BaseService<WxBlessingInfo,String>{
    AjaxJson saveBlessingInfo(WxBlessingInfo wxBlessingInfo);

    AjaxJson getBlessingInfo(String openid);
}
