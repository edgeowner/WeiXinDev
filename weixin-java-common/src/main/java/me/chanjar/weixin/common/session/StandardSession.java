...
public class StandardSession implements WxSession, InternalSession {
    ...
    public boolean equals(Object o) {
        ...
        return this.creationTime == session.creationTime &&
                this.expiring == session.expiring &&
                ...
                this.accessCount.equals(session.accessCount) &&
                this.attributes.equals(session.attributes) &&
                this.facade.equals(session.facade) &&
                this.id.equals(session.id) &&
                this.manager.equals(session.manager);
